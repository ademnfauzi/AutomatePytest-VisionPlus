...
def format_discord_message(df, platform):
    ...
    df['module'] = df['id'].str.extract(r'(new_vplus/test/.+?/)')
...
# Mac Mini
csv_file_path = '/Users/visionplus/Automation/AutomationWebSelenium/vplus/new_report/report.csv'  # Change this to the actual path
# My Local
# csv_file_path = '/Users/ade/Documents/Automation/AutomationWebSelenium/new_vplus/report/report.csv'  # Change this to the actual path
...
# Mac Mini
report_folder = '/Users/visionplus/Automation/AutomationWebSelenium/new_vplus/report/'
# My Local
# report_folder = '/Users/ade/Documents/Automation/AutomationWebSelenium/new_vplus/report/'
