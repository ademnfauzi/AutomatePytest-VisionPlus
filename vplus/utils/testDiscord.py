...
# Mac Mini
# csv_file_path = '/Users/visionplus/Automation/AutomationWebSelenium/vplus/report/report.csv'
# My Local
csv_file_path = '/Users/ade/Documents/Automation/AutomationWebSelenium/vplus/report/report.csv'
...
# Split the formatted message into chunks of maximum 500 characters
chunk_size = 500
...
for i, chunk in enumerate(chunks):
    if i < len(chunks) - 1:
        # Not the last chunk, send only the chunk with "See more" indication
